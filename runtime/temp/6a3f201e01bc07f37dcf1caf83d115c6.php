        ...
        <div class="row">
            <div class="col-xs-3" style="margin-bottom:15px;">
                <div class="panel panel-default panel-intro panel-statistics">
                    <div class="panel-body">
                        <h3>总文档数</h3>
                        <h4><?php echo $totalArchives; ?> 篇</h4>
                    </div>
                </div>
            </div>
            <div class="col-xs-3" style="margin-bottom:15px;">
                <div class="panel panel-default panel-intro panel-statistics">
                    <div class="panel-body">
                        <h3>待审核文档</h3>
                        <h4><?php echo $unsettleArchives; ?> 篇</h4>
                    </div>
                </div>
            </div>
            <div class="col-xs-3" style="margin-bottom:15px;">
            ...
            <div class="col-xs-3" style="margin-bottom:15px;">
                <div class="panel panel-default panel-intro panel-statistics">
                    <div class="panel-body">
                        <h3>待审核评论</h3>
                        <h4><?php echo $unsettleComment; ?> 条</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default panel-intro panel-statistics">
            <div class="panel-body">
                ...
                <table class="table" style="width:100%">
                    ...
                    <tbody>
                    <?php if(is_array($todayPaidList) || $todayPaidList instanceof \think\Collection || $todayPaidList instanceof \think\Paginator): if( count($todayPaidList)==0 ) : echo "
                    <tr>
                        <td colspan='3' class='text-center'>暂无数据</td>
                    </tr>
                    " ;else: foreach($todayPaidList as $key=>$item): ?>
                    <tr>
                        <td>
        ...
        <div class="panel panel-default panel-intro panel-statistics">
            <div class="panel-body">
                ...
                <table class="table" style="width:100%">
                    ...
                    <tbody>
                    <?php if(is_array($weekPaidList) || $weekPaidList instanceof \think\Collection || $weekPaidList instanceof \think\Paginator): if( count($weekPaidList)==0 ) : echo "
                    <tr>
                        <td colspan='3' class='text-center'>暂无数据</td>
                    </tr>
                    " ;else: foreach($weekPaidList as $key=>$item): ?>
                    <tr>
                        <td>
                            <p><a href="<?php echo $item['archives']['url']; ?>" target="_blank"><?php echo $item['archives']['title']; ?></a></p>
                        </td>
        ...
        <div class="panel panel-default panel-intro panel-statistics">
            <div class="panel-body">
                ...
                <table class="table" style="width:100%">
                    ...
                    <tbody>
                    <?php if(is_array($monthPaidList) || $monthPaidList instanceof \think\Collection || $monthPaidList instanceof \think\Paginator): if( count($monthPaidList)==0 ) : echo "
                    <tr>
                        <td colspan='3' class='text-center'>暂无数据</td>
                    </tr>
                    " ;else: foreach($monthPaidList as $key=>$item): ?>
                    <tr>
                        <td>
                            <p><a href="<?php echo $item['archives']['url']; ?>" target="_blank"><?php echo $item['archives']['title']; ?></a></p>
                        </td>
        ...
        <div class="panel panel-default panel-intro panel-statistics">
            <div class="panel-body">
                ...
                <table class="table" style="width:100%">
                    ...
                    <tbody>
                    <?php if(is_array($hotTagsList) || $hotTagsList instanceof \think\Collection || $hotTagsList instanceof \think\Paginator): if( count($hotTagsList)==0 ) : echo "
                    <tr>
                        <td colspan='2' class='text-center'>暂无数据</td>
                    </tr>
                    " ;else: foreach($hotTagsList as $key=>$item): ?>
                    <tr>
                        <td>
